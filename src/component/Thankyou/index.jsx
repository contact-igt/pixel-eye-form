...
const Thankyou = () => {
  return (
    ...
    >
      ...
      />
      <h1 className={`${styles.title} mt-3 fw-bold`}>
      ...
      <div className={styles.card}>
        ...
        <ul>
          <li>Our team will call or message you within 24 hours.</li>
          <li>
            Please bring any previous eye reports or prescriptions during your
            visit.
          </li>
        </ul>
      </div>
      <div className={styles.buttonContainer}>
        <a href="https://www.pixeleyehospitals.com/" className={styles.button}>
